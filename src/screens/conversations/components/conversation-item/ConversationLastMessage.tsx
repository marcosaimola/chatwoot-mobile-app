      ...
      <NativeView style={tailwind.style('flex-row gap-1 items-center')}>
        ...
        <Text
          ...
          style={tailwind.style(
            `text-md flex-1 font-inter-420-20 tracking-[0.32px] leading-[21px] ${colors.textSecondary}`,
          )}>
    ...
    return (
      <NativeView style={tailwind.style('flex-row gap-1 items-center')}>
        <Text
          ...
          style={tailwind.style(
            `text-md flex-1 font-inter-420-20 tracking-[0.3px] leading-[21px] ${colors.textSecondary}`,
          )}>
          <MessageType message={message} style={tailwind.style('ml-1')} />
          <Text
            numberOfLines={numberOfLines}
